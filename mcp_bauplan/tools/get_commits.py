            ...
            try:
                for commit in response:
                    try:
                        ...
                        author = AuthorInfo(
                            username=getattr(commit.author, 'username', None) if hasattr(commit, 'author') else None,
                            name=getattr(commit.author, 'name', None) if hasattr(commit, 'author') else None,
                            email=getattr(commit.author, 'email', None) if hasattr(commit, 'author') else None
                        )
