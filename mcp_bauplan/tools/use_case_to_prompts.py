bauplan_pipeline_prompt = (
    ...
    " and understand the comments and the syntax. THIS IS NOT TO BE COPIED AND PASTED IN THE FINAL ANSWER, IT IS"
    " JUST AN EXAMPLE OF A MINIMAL PROJECT, TO BE USED AS REFERENCE WHEN CREATING YOUR OWN CODE TO MAKE SURE"
    " THE PROJECT STRUCTURE IS CORRECT AND THAT YOU KNOW THE BASIC SYNTAX OF A BAUPLAN FILE WHEN DECIDING TO WRITE"
...
bauplan_repair_prompt = (
    ...
    " <file_name> -> <code_as_string> - check the data pipeline prompt from get_instructions for an example of a minimal project BEFORE generating any code."
